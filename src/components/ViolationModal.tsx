  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-md animate-in fade-in duration-300">
      <div className="bg-[#121212]/90 border border-amber-500/20 p-8 rounded-3xl max-w-md w-full text-center relative overflow-hidden shadow-[0_0_50px_rgba(245,158,11,0.1)]">
        ...
        <h3 className="text-xl font-bold text-white mb-2 flex items-center justify-center gap-2" style={{ fontFamily: "var(--font-head), serif", letterSpacing: "-0.015em", fontWeight: 600 }}>
          <AlertTriangle className="text-amber-500 size-4.5 animate-pulse" size={18} strokeWidth={1.75} />
        ...
        <div className="space-y-3">
          <div className="text-left text-xs bg-white/5 border border-white/5 p-4 rounded-xl space-y-2 text-muted-foreground font-medium">
